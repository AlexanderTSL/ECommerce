    ...
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            if (!dbContext.Products.Any())
            {
                ...
                dbContext.Products.Add(new Db.Product() { Id = 2, Name = "Mouse", Price = 7, Inventory = 200 });
                dbContext.Products.Add(new Db.Product() { Id = 3, Name = "Monitor", Price = 150, Inventory = 320 });
